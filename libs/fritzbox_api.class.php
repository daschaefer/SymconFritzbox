...
class fritzbox_api {
  ...
  /**
    ...
    * @access public
    */
  public function __construct($ipsID, $config_version = 'standard')
  {
    // init the config object
    $this->config = new fritzbox_api_config($ipsID);
...
class fritzbox_api_config {
  ...
  public function __construct($ipsID)
  {
    $this->setItem('ipsID', $ipsID);
    ...
    $this->setItem('fritzbox_ip', IPS_GetProperty($ipsID, "FBX_IP"));
    ...
    $this->setItem('username', IPS_GetProperty($ipsID, "FBX_USERNAME"));
    
    # set to your Fritz!Box password (defaults to no password)
    $this->setItem('password', IPS_GetProperty($ipsID, "FBX_PASSWORD"));
